...
(function(){
  ...
  /* 2026-08再調整：改用「有色部分」normalize大小之後（見
     ...
     ★ 2026-08再調整：商品放入1200畫布時，整體大小再縮小10%
     （PRODUCT_BASE_HPCT 0.40→0.36），大中小之間的相對比例不受影響，
     一樣只影響「第一次上傳、還沒有savedTransform」時的初始大小。 */
  var PRODUCT_BASE_HPCT   = 0.36;
  var PRODUCT_POS_CENTER = { xPct: 0.5,  yPct: 0.66, hPct: PRODUCT_BASE_HPCT }; // 三個裡最大、最主要，剛好在畫布正中央
  var PRODUCT_POS_RIGHT  = { xPct: 0.72, yPct: 0.74, hPct: PRODUCT_BASE_HPCT }; // 2026-08再調整：往右下移一點，原本0.66/0.64太貼近中間商品
  var PRODUCT_POS_LEFT   = { xPct: 0.26, yPct: 0.74, hPct: PRODUCT_BASE_HPCT };
