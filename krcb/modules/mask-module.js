...
/* 每個版位的參數：
   ...
   _default這組。 */
var MASK_CONFIG = {
  _default:     { height: 91, leftDrop: 89, dip: 60, dipX: 0.83, color: '#fcdbc5' },
  '11_lpbn_app':{ height: 91, leftDrop: 89, dip: 60, dipX: 0.83, color: '#fcdbc5' },
  '12_lpbn_pc': { height: 65, leftDrop: 63, dip: 40, dipX: 0.83, color: '#fcdbc5' },
  /* IG／DD Card：形狀跟LPBN不一樣——leftDrop:0(左右兩側同高，不是LPBN那種
     ...
     維持整體遮罩家族視覺一致。 */
  '04_ig':      { height: 202, leftDrop: 0, dip: 129, dipX: 0.5, color: '#fcdbc5' },
  '05_ddcard':  { height: 127, leftDrop: 0, dip: 81, dipX: 0.5, color: '#fcdbc5' }
};
