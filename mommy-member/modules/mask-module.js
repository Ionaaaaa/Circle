...
/* 每個版位的參數：
   ...
   _default這組。 */
var MASK_CONFIG = {
  _default:     { height: 91, leftDrop: 89, dip: 60, dipX: 0.83, color: '#f78066' },
  '11_lpbn_app':{ height: 91, leftDrop: 89, dip: 60, dipX: 0.83, color: '#f78066' },
  '12_lpbn_pc': { height: 65, leftDrop: 63, dip: 40, dipX: 0.83, color: '#f78066' }
};
